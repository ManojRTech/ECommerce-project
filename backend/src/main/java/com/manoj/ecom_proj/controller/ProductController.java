...
@RestController
@CrossOrigin // for 2 diff ports (frontend-5173, backend-8080) to communicate
@RequestMapping("/api")
public class ProductController {
    ...
    @GetMapping("/products")
    public ResponseEntity<List<Product>> getAllProducts(){ // return responseEntity-(sends the status also!) & product list
